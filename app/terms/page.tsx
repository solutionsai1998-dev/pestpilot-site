...
const sections: Section[] = [
  ...
  {
    title: "6. Online Payments to Your Company (Stripe Connect)",
    paragraphs: [
      "The Service allows your Company to accept online payments from your Customers (for example, invoice payments made through the Customer Portal). These payments are processed through Stripe Connect. To enable online payments, the Company must create and maintain a connected Stripe account and agree to the Stripe Connected Account Agreement, which incorporates the Stripe Terms of Service. Stripe may require identity and business verification before payouts are enabled.",
      "Online payments are transactions between the Company and its Customers. PestPilot is not a party to those transactions, is not a bank or money transmitter, and is not responsible for the services the Company sells. The Company is solely responsible for refunds, chargebacks, and disputes with its Customers, and any associated processor or dispute fees may be deducted from the Company's connected Stripe account.",
      "Each online payment is subject to Stripe's payment processing fees and to any PestPilot online payment fee in effect at the time of the transaction, as disclosed on our pricing page or in your billing dashboard. These fees are deducted automatically from the payment amount and are non-refundable — including on transactions that are later refunded or disputed — except where required by law."
    ]
  },
  {
    title: "7. SMS/Text Messaging (A2P 10DLC Compliance)",
    paragraphs: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Upon termination: your right to use the Service ends at the close of the current billing period; all outstanding fees become immediately due; we may retain data as required by law or for dispute resolution; and Sections 9, 11, 13, 15, 16, 17, and 18 survive termination."
    ]
  },
  {
