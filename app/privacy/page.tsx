...
export const metadata: Metadata = {
  ...
  description: "Privacy Policy for PestPilot pest control software."
};
...
const sections = [
  {
    ...
    paragraphs: [
      "We may collect information you provide directly, such as account details, billing contacts, service addresses, technician information, customer records, and support requests submitted through the Service.",
  ...
  },
  {
    ...
    paragraphs: [
      "PestPilot may use collected information to provide and maintain the Service, process transactions, authenticate users, respond to support inquiries, improve features, monitor performance, and communicate important account or product updates.",
  ...
  },
  {
    ...
    paragraphs: [
      "We may share information with service providers that help us host, secure, analyze, support, or process payments for the Service, subject to contractual protections. We do not sell personal information.",
      "We may also disclose information where required by law, legal process, or valid governmental request, or where reasonably necessary to protect the rights, safety, or property of PestPilot, our users, or others."
    ]
  },
  {
    title: "Data Security",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "PestPilot is not responsible for the privacy practices of third parties except as required by law or expressly stated in a separate agreement."
    ]
  },
  {
    title: "Children's Privacy",
    paragraphs: [
      "PestPilot is intended for business use and is not directed to children. PestPilot does not knowingly collect personal information from children in connection with the Service."
    ]
  },
  {
    title: "Changes to This Policy",
    paragraphs: [
      "PestPilot may update this Privacy Policy from time to time to reflect changes in our practices, legal requirements, or product features. We will post the updated version with a revised effective date, and may provide additional notice where required by law."
    ]
  },
  {
    title: "Contact Us",
